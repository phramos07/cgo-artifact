...
static int32_t g_9[7][6] = {{9L,9L,9L,9L,9L,9L},{9L,9L,9L,9L,9L,9L},{9L,9L,9L,9L,9L,9L},{9L,9L,9L,9L,9L,9L},{9L,9L,9L,9L,9L,9L},{9L,9L,9L,9L,9L,9L},{9L,9L,9L,9L,9L,9L}};
...
{ /* block id: 0 */
    int32_t *l_2 = &g_3;
    int32_t *l_4 = (void*)0;
    int8_t l_5[4] = {0x90L,0x90L,0x90L,0x90L};
    int32_t *l_6 = &g_3;
    int32_t *l_7[5][1] = {{(void*)0},{&g_3},{(void*)0},{&g_3},{(void*)0}};
    uint64_t l_10 = 0x1AC8C6DCFF2FD6B2LL;
    int i, j;
    l_10++;
    (*l_6) |= (g_9[1][1] = g_8);
    return g_8;
