...
p3 = plt.bar(ind+width, time_Combine, width, color='g', bottom=[i+j for i,j in zip(time_PDD,time_LTC)])
...
plt.legend((p0[0], p1[0], p2[0], p3[0]), ('Total Time SRAA', 'Time_PDD', 'Time_LTC', 'Ranges'))
