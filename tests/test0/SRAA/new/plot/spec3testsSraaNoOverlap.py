...
evalsraa=csv2rec('../report.evalsraaSpecNoOverlap.csv', delimiter=',')
...
p4 = plt.bar(ind+2*width, basic, width, color='b')
...
plt.legend((p0[0], p1[0], p2[0], p3[0], p4[0]), ('Total SRAA', 'PDD', 'LTC', 'Ranges', 'basicaa'))
